                    ...
                    <FadeIn>
                        <div className="h-screen max-h-screen">
                            ...
                            {isLoading ? (
                                ...
                                <FadeIn>
                                    <div className="rounded-2xl m-10 w-999 w-96 mx-auto bg-gray-50 text-gray-800 h-96 overflow-y-auto border-2 border-orange-400 hover:border-gray-600 transition transform hover:scale-110 h-64">
                            ...
                            {user ? (
                                ...
                                <div className="w-52 justify-center items-center m-auto">
                                    <div className="outline-none bg-green-600 flex p-4 rounded-2xl hover:bg-green-500 transition text-white">
                                        <a
                                            href="api/auth/login"
